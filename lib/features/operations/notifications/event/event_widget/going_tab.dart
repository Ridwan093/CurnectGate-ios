...
class GoingEventsSliver {
  final String going;
  GoingEventsSliver({required this.going});

  List<Widget> buildSlivers(BuildContext context, WidgetRef ref) {
    final asyncValue = ref.watch(goingEventRsvpProvider(going));

    return [
      CupertinoSliverRefreshControl(onRefresh: () => refreshRsvp(ref, going)),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10),
          Text(
            "Your event details appear here",
            style: TextStyle(
              fontSize: 12,
              fontWeight: FontFamilies.medium,
              color: AppColors.instance.black300,
