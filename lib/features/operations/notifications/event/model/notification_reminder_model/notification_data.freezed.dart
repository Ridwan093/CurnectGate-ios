...
abstract class $NotificationDataCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'notifications') List<NotificationItem>? notifications,
...
class _$NotificationDataImpl implements _NotificationData {
  ...
  @override
  String toString() {
    return 'NotificationData(notifications: $notifications, count: $count)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_notifications), count);
