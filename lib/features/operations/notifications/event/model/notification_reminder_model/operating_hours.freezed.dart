...
class _$OperatingHoursImpl implements _OperatingHours {
  const _$OperatingHoursImpl(
      {@JsonKey(name: 'gate_open') required this.gateOpen,
      @JsonKey(name: 'gate_close') required this.gateClose});
...
abstract class _OperatingHours implements OperatingHours {
  const factory _OperatingHours(
          {@JsonKey(name: 'gate_open') required final String? gateOpen,
          @JsonKey(name: 'gate_close') required final String? gateClose}) =
