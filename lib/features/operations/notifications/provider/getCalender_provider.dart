...
final getCalenderProvider =
    AsyncNotifierProvider.autoDispose<CalenderNotifier, EventsResponse?>(() {
      return CalenderNotifier();
    });

class CalenderNotifier extends AutoDisposeAsyncNotifier<EventsResponse?> {
  @override
  Future<EventsResponse?> build() async {
    // First try to load from local storage
    final localEvent = await SharedPrefsService.getcalendder();
