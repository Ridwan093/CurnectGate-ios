...
class GenerateOTPWithValidity extends ConsumerStatefulWidget {
  const GenerateOTPWithValidity({super.key});

  @override
  ConsumerState<GenerateOTPWithValidity> createState() =>
      _GenerateOTPWithValidityState();
}

class _GenerateOTPWithValidityState
    extends ConsumerState<GenerateOTPWithValidity> {
  // Controllers for text inputs
  final _visitorController = TextEditingController();
  final _vehicleController = TextEditingController();
  final _phoneController = TextEditingController();

  // Local state for dropdown (instant UI feedback without provider rebuilds)
  String? _selectedPurpose;

  @override
  void initState() {
    super.initState();
    // Load initial value from provider if you need to prefill
  ...
  bool get _isFormValid {
    ...
    final period = ref.read(generateNotifierProvider).visitperiod ?? '';

    return visitor.isNotEmpty && purpose.isNotEmpty && period.isNotEmpty;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // Purpose Dropdown (local state for instant feedback)
        ...
        _buildSubmitButton(
          ...
          context: context,
          onTap: () {
            // Save values only when submitting
            ref
            ...
            ref
                ...
                .generateOtpWithValidity(context: context, ref: ref);
          },
        ),
      ],
    );
  ...
  Widget _buildSubmitButton({
    ...
    final realLoading = ref.watch(formProvider).generateOtpWithValidatorLoading;
