...
class DenyEntry extends ConsumerStatefulWidget {
  final String id;
  DenyEntry({super.key, required this.id});

  @override
  ConsumerState<DenyEntry> createState() => _DenyEntryState();
}

class _DenyEntryState extends ConsumerState<DenyEntry> {
