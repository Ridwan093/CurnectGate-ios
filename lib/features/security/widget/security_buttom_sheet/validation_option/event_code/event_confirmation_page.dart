        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (eventCode["event_location"] != null && eventCode["event_location"].toString().isNotEmpty) ...[
                const Divider(height: 24),
                _buildDetailItem(
              ...
              if (eventCode["event_description"] != null && eventCode["event_description"].toString().isNotEmpty) ...[
                const Divider(height: 24),
                _buildDetailItem(
                ...
                children: [
                  ...
                  Expanded(
                    child: _buildDetailItem(
                      ...
                      label: "End Time",
                      value: _formatTime(eventDetails["end_time"]?.toString()),
                    ),
                  ),
                ],
              ),
