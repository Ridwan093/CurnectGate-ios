...
class GrantDigitalEntry extends ConsumerStatefulWidget {
  final String id;
  final String otpCode;
  GrantDigitalEntry({super.key, required this.id, required this.otpCode});

  @override
  ConsumerState<GrantDigitalEntry> createState() => _DenyEntryState();
}

class _DenyEntryState extends ConsumerState<GrantDigitalEntry> {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    "Specifie the reason for grant entry",
                    style: TextStyle(
                      fontFamily: FontFamilies.interDisplay,
                      fontSize: 13,
