...
class ValidateWorkOrderCheckIn extends ConsumerStatefulWidget {
  final String validateType;
  ValidateWorkOrderCheckIn({super.key, required this.validateType});

  @override
  ConsumerState<ValidateWorkOrderCheckIn> createState() =>
      _ValidateWorkOrderOtpState();
}

class _ValidateWorkOrderOtpState extends ConsumerState<ValidateWorkOrderCheckIn> {
          ...
          formState.otpallValid
              ? () {
                if (formState.accessType == "Checkin") {
                  providerState.workOderChekInOtp(
                    context: context,
                  ...
                  providerState.workOrderCheckOut(
                    context: context,
                    otpCode: formState.otpCode ?? "",
