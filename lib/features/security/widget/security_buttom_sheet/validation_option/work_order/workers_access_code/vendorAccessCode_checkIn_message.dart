...
class VendorCheckInMessage extends StatelessWidget {
  final String jsonData;
  const VendorCheckInMessage({super.key, required this.jsonData});
  ...
  Widget build(BuildContext context) {
    ...
    final day = extractedData["data"]["day"] ?? "N/A";
      ...
      child: Column(
        children: [
          ...
          _buildUserInfoBox(
            ...
            checkOutTime: formatDateTime(visitor['updated_at'] ?? "N/A"),
            duration: day,
          ),
          SizedBox(height: 30),
          _buildFeatureButton(
  ...
  Widget _buildUserInfoBox({
    ...
    return Column(
      children: [
        ...
        SizedBox(height: 30),
        _buildText(
          title: "Checkin Completed",
          subtitle: "Worker ",
          userName: userName,
          details: [
            "Check-in: $checkInTime",
            "Date Apoint: $checkOutTime",
            "Check-In Day: $duration",
          ],
        ),
      ],
    );
