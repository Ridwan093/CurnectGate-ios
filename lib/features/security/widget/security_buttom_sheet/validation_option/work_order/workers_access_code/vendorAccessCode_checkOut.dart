...
class VendorAccessCodeCheckOut extends ConsumerStatefulWidget {
  final String otpCode;
  VendorAccessCodeCheckOut({super.key, required this.otpCode});

  @override
  ConsumerState<VendorAccessCodeCheckOut> createState() =>
      _ValidateWorkOrderOtpState();
}

class _ValidateWorkOrderOtpState
    extends ConsumerState<VendorAccessCodeCheckOut> {
