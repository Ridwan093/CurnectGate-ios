...
class GrantPermitEntry extends ConsumerStatefulWidget {
  final String id;
  final String otpCode;
  GrantPermitEntry({super.key, required this.id, required this.otpCode});

  @override
  ConsumerState<GrantPermitEntry> createState() => _DenyEntryState();
}

class _DenyEntryState extends ConsumerState<GrantPermitEntry> {
          ...
          _securityNotedController.text.isNotEmpty &&
              ...
              ? () {
                ...
                providerState.permitGrantAccess(
                  context: context,
                  code: widget.otpCode,
                  note: _securityNotedController.text.trim(),
                  id: id,
                  ref: ref,
                );
