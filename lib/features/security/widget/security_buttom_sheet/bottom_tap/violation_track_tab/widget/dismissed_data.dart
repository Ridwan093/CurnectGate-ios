...
class DismissedData extends ConsumerWidget {
  const DismissedData({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final reportAsync = ref.watch(dismissProvider);
  ...
  Widget _buildReportList(List<Violation> violations, WidgetRef ref) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          onTap: () {
            // context.pushNamed(AppRoutes.securityViolationDeatails);
            Navigator.push(
              context,
              PageRouteBuilder(
