...
class SecurityReportBody extends ConsumerWidget {
  const SecurityReportBody({super.key});
  ...
  void main() {
    String inputDate = "2025-08-21T16:14:06.000000Z";
    String formattedDate = formatDate(inputDate);
    print(formattedDate); // Output: August 21, 2025
  }

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final reportAsync = ref.watch(investigatingProvider);

    return RefreshIndicator(
      color: AppColors.instance.yellow500,
      onRefresh:
          () => ref
              .read(investigatingProvider.notifier)
  ...
  Widget _buildReportList(List<Violation> violations, WidgetRef ref) {
    final state = ref.watch(oTpformProvider.notifier);
