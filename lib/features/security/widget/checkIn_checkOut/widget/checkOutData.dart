...
class CheckOutData extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final reportAsync = ref.watch(getCheckOutProvider);
    ...
    return RefreshIndicator(
      ...
      child: Padding(
        ...
        child: reportAsync.when(
          data: (report) {
            try {
              final visitor = report?.data?.history;
              if (visitor != null) {
          ...
          loading: () {
            try {
              final cachedReport = ref.read(getCheckOutProvider).value;
              final cachedVisitor = cachedReport?.data?.history;
          ...
          error: (error, stack) {
            try {
              ...
              final cachedReport = ref.read(getCheckOutProvider).value;
              final cachedViolations = cachedReport?.data?.history;
