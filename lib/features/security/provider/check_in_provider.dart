...
final getCheckInProvider =
    AsyncNotifierProvider.autoDispose<CheckInNotifier, ApiResponseModel?>(() {
      return CheckInNotifier();
    });

class CheckInNotifier extends AutoDisposeAsyncNotifier<ApiResponseModel?> {
  @override
  Future<ApiResponseModel?> build() async {
    // First try to load from local storage
    final localCheckOut = await SharedPrefsService.getChekIn();
  ...
  Future<void> refreshCheckIn(BuildContext context, WidgetRef ref) async {
