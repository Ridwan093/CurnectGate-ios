...
mixin _$ApiResponseModel {
  ...
  DataPayload? get data => throw _privateConstructorUsedError;
...
abstract class $ApiResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? status, String? message, int? code, DataPayload? data});

  $DataPayloadCopyWith<$Res>? get data;
}
...
class _$ApiResponseModelCopyWithImpl<$Res, $Val extends ApiResponseModel>
  ...
  $DataPayloadCopyWith<$Res>? get data {
    ...
    return $DataPayloadCopyWith<$Res>(_value.data!, (value) {
...
class _$ApiResponseModelImpl implements _ApiResponseModel {
  ...
  @override
  String toString() {
    return 'ApiResponseModel(status: $status, message: $message, code: $code, data: $data)';
  }
...
abstract class _ApiResponseModel implements ApiResponseModel {
  const factory _ApiResponseModel(
      ...
      final String? message,
      final int? code,
      final DataPayload? data}) = _$ApiResponseModelImpl;
