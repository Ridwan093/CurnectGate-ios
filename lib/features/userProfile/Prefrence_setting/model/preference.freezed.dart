...
class _$PreferenceImpl implements _Preference {
  ...
  @override
  String toString() {
    return 'Preference(name: $name, description: $description, type: $type, options: $options, key: $key, value: $value)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, name, description, type,
      const DeepCollectionEquality().hash(_options), key, value);
...
abstract class _Preference implements Preference {
  const factory _Preference(
      ...
      final List<Option>? options,
      final String? key,
      final String? value}) = _$PreferenceImpl;
