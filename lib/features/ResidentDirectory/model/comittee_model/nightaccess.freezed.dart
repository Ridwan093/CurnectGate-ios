...
mixin _$NightAccess {
  ...
  NightAccessConditions? get conditions => throw _privateConstructorUsedError;
...
abstract class $NightAccessCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool? enabled, NightAccessConditions? conditions});

  $NightAccessConditionsCopyWith<$Res>? get conditions;
}
...
class _$NightAccessCopyWithImpl<$Res, $Val extends NightAccess>
  ...
  $NightAccessConditionsCopyWith<$Res>? get conditions {
    ...
    return $NightAccessConditionsCopyWith<$Res>(_value.conditions!, (value) {
...
class _$NightAccessImpl implements _NightAccess {
  const _$NightAccessImpl({this.enabled, this.conditions});
  ...
  final bool? enabled;
  @override
  final NightAccessConditions? conditions;
...
abstract class _NightAccess implements NightAccess {
  const factory _NightAccess(
      {final bool? enabled,
      final NightAccessConditions? conditions}) = _$NightAccessImpl;
  ...
  bool? get enabled;
  @override
  NightAccessConditions? get conditions;
