...
class Resident with _$Resident {
  ...
  factory Resident.fromSafeJson(Map<String, dynamic> json) {
    return Resident(
      ...
      isCommitteeMember: NullSafetyHelper.safeBool(json['is_committee_member']),
      isBoardMember: NullSafetyHelper.safeBool(json['is_board_member']),
      leadershipRoles: _leadershipRolesFromJson(json['leadership_roles']),
      joinedDate: NullSafetyHelper.safeDateTime(json['joined_date']),
