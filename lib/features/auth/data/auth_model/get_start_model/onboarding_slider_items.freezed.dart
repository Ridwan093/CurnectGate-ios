...
class _$SliderItemImpl implements _SliderItem {
  ...
  @override
  String toString() {
    return 'SliderItem(id: $id, title: $title, description: $description, imageUrl: $imageUrl, order: $order)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, imageUrl, order);
...
abstract class _SliderItem implements SliderItem {
  const factory _SliderItem(
      ...
      final String? description,
      final String? imageUrl,
      final int? order}) = _$SliderItemImpl;
