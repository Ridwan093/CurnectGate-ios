...
class ForgetPassOtpScreen extends BaseVerificationScreen {
  final String data;

  const ForgetPassOtpScreen(this.data, {super.key})
    : super(
        currentStep: 5,
        totalSteps: 5,
  ...
  @override
  ConsumerState<ForgetPassOtpScreen> createState() => _OtpScreenState();
}

class _OtpScreenState extends ConsumerState<ForgetPassOtpScreen> {
