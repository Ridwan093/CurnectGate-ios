...
final getActiveOtpHistoryProvider =
...
class ActiveOtpnotifier extends AutoDisposeAsyncNotifier<OtpResponseModel?> {
  ...
  Future<OtpResponseModel?> build() async {
    ...
    final localVendor = await SharedPrefsService.getActiveHistory();

    try {
      // Then try to fetch fresh data
      final token = await ref.watch(accessTokenProvider.future);
      final statue = ref.watch(generateNotifierProvider).historyfilter;
