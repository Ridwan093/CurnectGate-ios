...
import 'package:curnectgate/features/member_management/Onboard_Houselod/widget/restrition_data.dart';
...
class _AddRestrictionsState extends ConsumerState<AddRestrictions> {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      onRefresh:
          () => ref
              .read(getRestrictionStatus.notifier)
              .refresrestrict(context, ref, widget.id),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  RestrictIonStatus(id: widget.id,),
