...
class VisitorSettingsScreen extends ConsumerWidget {
  final int id;
  const VisitorSettingsScreen({super.key, required this.id});
        ...
        data: (profile) {
          try {
            ...
            if (user != null && user.permissions != null) {
              return VisitorInivitaitonCotent(
                permission: user.permissions,
                id: id,
              );
            } else {
              return EmptyBodys(message: "No visitor settings?");
            }
          } catch (e) {
            return Builderroul(
              error: e.toString(),
              onTap:
                  () => ref
                      .read(statisticProvider.notifier)
                      .refreshPermission(context, ref),
              firstMessae: "Faile to load visitor setting?",
            );
          }
        },
        loading: () {
            ...
            return Builderroul(
              ...
              onTap:
                  () => ref
                      .read(statisticProvider.notifier)
                      .refreshPermission(context, ref),
              firstMessae: "Faile to load visitor settings?",
            );
          } catch (e) {
            return Builderroul(
              error: e.toString(),
