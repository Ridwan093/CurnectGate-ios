...
class RemovedRestrictions extends ConsumerWidget {
  final int? id;
  final String userName;
  const RemovedRestrictions({
    super.key,
    required this.id,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isLoading = ref.watch(formProvider).basicPermissionLoading ?? false;
    return Column(
      ...
      children: [
        ...
        Buttonss(
          onPressed: () {
            form.landlordRemoveRestrictions(context: context, id: id?? 0, ref: ref);
          },
          child:
              isLoading
                  ? Loadingstates()
