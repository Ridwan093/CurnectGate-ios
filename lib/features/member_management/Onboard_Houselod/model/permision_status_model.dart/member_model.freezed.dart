...
class _$MemberImpl implements _Member {
  ...
  @override
  String toString() {
    return 'Member(id: $id, name: $name, email: $email, role: $role, estateId: $estateId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, email, role, estateId);
...
abstract class _Member implements Member {
  const factory _Member(
      ...
      final String? email,
      final String? role,
      @JsonKey(name: 'estate_id') final int? estateId}) = _$MemberImpl;
