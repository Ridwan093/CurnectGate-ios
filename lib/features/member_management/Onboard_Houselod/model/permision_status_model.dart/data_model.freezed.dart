...
mixin _$PermissionsData {
  ...
  Map<String, MemberPermission>? get permissions =>
    ...
    return _then(_value.copyWith(
      ...
      permissions: freezed == permissions
          ...
          : permissions // ignore: cast_nullable_to_non_nullable
              as Map<String, MemberPermission>?,
...
class _$PermissionsDataImpl implements _PermissionsData {
  const _$PermissionsDataImpl(
      {this.member,
      final Map<String, MemberPermission>? permissions,
      this.summary})
  ...
  @override
  final Member? member;
  final Map<String, MemberPermission>? _permissions;
  @override
  Map<String, MemberPermission>? get permissions {
