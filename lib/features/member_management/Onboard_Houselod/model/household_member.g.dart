...
_$HouseholdMemberImpl _$$HouseholdMemberImplFromJson(
    ...
    _$HouseholdMemberImpl(
      ...
      permissionsSummary: json['permissions_summary'] == null
          ? null
          : PermissionsSummary.fromJson(
              json['permissions_summary'] as Map<String, dynamic>),
      permissionGrants: (json['permission_grants'] as List<dynamic>?)
          ?.map((e) => PermissionGrant.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$$HouseholdMemberImplToJson(
    ...
    <String, dynamic>{
      ...
      'permissions_summary': instance.permissionsSummary?.toJson(),
      'permission_grants':
          instance.permissionGrants?.map((e) => e.toJson()).toList(),
