...
mixin _$HouseholdPermissions {
  ...
  @JsonKey(name: 'visitor_invitation')
...
class _$HouseholdPermissionsImpl implements _HouseholdPermissions {
  const _$HouseholdPermissionsImpl(
      ...
      @JsonKey(name: 'visitor_invitation') this.visitorInvitation});
...
abstract class _HouseholdPermissions implements HouseholdPermissions {
  const factory _HouseholdPermissions(
      {@JsonKey(name: 'gate_access') final GateAccess? gateAccess,
      @JsonKey(name: 'night_access') final NightAccess? nightAccess,
      @JsonKey(name: 'facility_access') final FacilityAccess? facilityAccess,
      @JsonKey(name: 'visitor_invitation')
