...
class _$EstateSettingsImpl implements _EstateSettings {
  const _$EstateSettingsImpl(
      {@JsonKey(name: 'auto_approve_users') this.autoApproveUsers,
      @JsonKey(name: 'require_deed_signature') this.requireDeedSignature,
      @JsonKey(name: 'visitor_approval_required') this.visitorApprovalRequired,
      @JsonKey(name: 'emergency_contacts')
      ...
      @JsonKey(name: 'image_Key') this.imageKeyAlt})
...
abstract class _EstateSettings implements EstateSettings {
  const factory _EstateSettings(
      {@JsonKey(name: 'auto_approve_users') final bool? autoApproveUsers,
      @JsonKey(name: 'require_deed_signature') final bool? requireDeedSignature,
      @JsonKey(name: 'visitor_approval_required')
      final bool? visitorApprovalRequired,
      @JsonKey(name: 'emergency_contacts')
      final Map<String, List<dynamic>>? emergencyContacts,
      ...
      @JsonKey(name: 'operating_hours') final OperatingHours? operatingHours,
      @JsonKey(name: 'image_Key')
      final String? imageKeyAlt}) = _$EstateSettingsImpl;
