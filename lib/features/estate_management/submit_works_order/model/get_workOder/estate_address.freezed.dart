...
mixin _$EstateAddress {
  ...
  int? get skipDuplicateCheck => throw _privateConstructorUsedError;
  String? get duplicateAction => throw _privateConstructorUsedError;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.skipDuplicateCheck, skipDuplicateCheck) ||
                other.skipDuplicateCheck == skipDuplicateCheck) &&
            (identical(other.duplicateAction, duplicateAction) ||
...
abstract class _EstateAddress implements EstateAddress {
  const factory _EstateAddress(
      ...
      final List<dynamic>? additionalInfo,
      final String? createdAt,
      final String? updatedAt}) = _$EstateAddressImpl;
