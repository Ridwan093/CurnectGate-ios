...
class _$UserStatusImpl implements _UserStatus {
  const _$UserStatusImpl({this.hasVoted});
  ...
  @override
  String toString() {
    return 'UserStatus(hasVoted: $hasVoted)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, hasVoted);
...
abstract class _UserStatus implements UserStatus {
  const factory _UserStatus({final bool? hasVoted}) = _$UserStatusImpl;
