...
class _$CandidateItemImpl implements _CandidateItem {
  const _$CandidateItemImpl(
      {this.id, this.name, this.bio, this.partyAffiliation, this.mediaUrl});
  ...
  @override
  String toString() {
    return 'CandidateItem(id: $id, name: $name, bio: $bio, partyAffiliation: $partyAffiliation, mediaUrl: $mediaUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, bio, partyAffiliation, mediaUrl);
...
abstract class _CandidateItem implements CandidateItem {
  const factory _CandidateItem(
      {final int? id,
      final String? name,
      final String? bio,
      final String? partyAffiliation,
      final String? mediaUrl}) = _$CandidateItemImpl;
